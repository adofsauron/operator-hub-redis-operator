...
func main() {
	...
	flag.StringVar(&metricsAddr, "metrics-bind-address", ":8040", "The address the metric endpoint binds to.")
	flag.StringVar(&probeAddr, "health-probe-bind-address", ":8041", "The address the probe endpoint binds to.")
